...
This uncontrollable intelligence feedback loop is often called "Foom!".  This "Foom!" process is usually expected only to be stopped by the fundamental limits of physics.  Scientist and Mathematicians have calculated these physical limits of intelligence and computation, and these limits are extremely vast!  For example, a system could eventually convert all the atoms in all the planets into "computronium" powered by all the energy from our Sun, or our Galaxy.  Yes, those are the expected limits of this process of "Foom!".  
